package com.wemingle_chat.chat.global.token;


import com.wemingle_chat.chat.domain.entity.role.Role;
...
public class TokenProvider {
    ...
    public Authentication getAuthentication(String jwtToken){
        ...
        switch (role){
            ...
            default -> throw new RuntimeException("InvalidRoleException");
        }
    }
